...
$page_title = __('record_new_import');
            ...
            <div class="card-body">
                ...
                <form action="add_backend.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="store_id"><?php echo __('import_to_store'); ?></label>
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary mr-2"><?php echo __('record_import'); ?></button>
