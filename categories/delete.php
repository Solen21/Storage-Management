...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    try {
        ...
        $stmt->execute();
        if ($stmt->rowCount() == 1) {
            $category_to_delete = $stmt->fetch(PDO::FETCH_ASSOC);
        } else {
...
<div class="row justify-content-center mt-5">
    <div class="col-md-8 col-lg-6">
        <div class="card shadow">
            ...
            <div class="card-body">
                <p class="text-center">Are you sure you want to delete the category: <strong><?php echo htmlspecialchars($category_to_delete['name']); ?></strong>?</p>
                <p class="text-center text-danger">This action cannot be undone and may fail if the category is in use by products.</p>
                <form action="delete_backend.php" method="post" class="text-center">
                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($category_to_delete['id']); ?>">
