                ...
                <form action="add_backend.php" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="width" id="width" class="form-control" step="0.01" placeholder="e.g., 60.00">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="height">Height (cm)</label>
                            <input type="number" name="height" id="height" class="form-control" step="0.01" placeholder="e.g., 60.00">
                        </div>
                    </div>
                    <div class="form-group">
