...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    $delete_id = $_GET['id'];
    try {
        $stmt = $pdo->prepare("SELECT id, report_date FROM reports WHERE id = :id");
...
<div class="row justify-content-center mt-5">
    <div class="col-md-8 col-lg-6">
        <div class="card shadow">
            ...
            <div class="card-body">
                <p class="text-center">Are you sure you want to delete the report generated on <strong><?php echo htmlspecialchars($report_to_delete['report_date']); ?></strong>?</p>
