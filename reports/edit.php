...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    $edit_id = $_GET['id'];
    try {
        $stmt = $pdo->prepare("SELECT id, description FROM reports WHERE id = :id");
...
$page_title = 'Edit Report Description';
            ...
            <div class="card-body">
                ...
                <form action="edit_backend.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="4"><?php echo htmlspecialchars($report_to_edit['description']); ?></textarea>
                    </div>
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary mr-2">Update Description</button>
