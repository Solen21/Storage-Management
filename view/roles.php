...
$roles = $pdo->query("SELECT id, name, description, created_at FROM roles ORDER BY id ASC")->fetchAll();
...
<div class="container mt-5">
    <div class="row mb-3">
        ...
        <div class="col text-right">
            <a href="../roles/add.php" class="btn btn-success">Add New Role</a>
        </div>
    </div>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="../roles/edit.php?id=<?php echo $role['id']; ?>" class="btn btn-primary btn-sm">Edit</a>
                        <a href="../roles/delete.php?id=<?php echo $role['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
