...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    $delete_id = $_GET['id'];
    try {
        $stmt = $pdo->prepare("SELECT id, factory_code FROM products WHERE id = :id");
...
<div class="row justify-content-center mt-5">
    <div class="col-md-8 col-lg-6">
        <div class="card shadow">
            ...
            <div class="card-body">
                <p class="text-center">Are you sure you want to delete the product with Factory Code: <strong><?php echo htmlspecialchars($product_to_delete['factory_code']); ?></strong>?</p>
                <p class="text-center text-danger">This action cannot be undone and may fail if the product is in storage or part of an import/export record.</p>
